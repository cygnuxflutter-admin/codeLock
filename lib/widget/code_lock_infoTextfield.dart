...
class Info_textField extends StatefulWidget {
  Info_textField({
    Key? key,
    this.controller,
  ...
  bool obscureText;
  @override
  State<Info_textField> createState() => _Info_textFieldState();
}

class _Info_textFieldState extends State<Info_textField> {
  @override
